...
router.post(
  "/register",
  validate(registerUserSchema, "body"), // Valide les données d'inscription
  register
);
...
router.post(
  "/login",
  validate(loginUserSchema, "body"), // Valide les données de connexion
  login
);
...
// **Récupérer les employés disponibles un jour donné, à une heure donnée**
router.get(
  "/available",
  //isAuthenticated, // Vérifie que l'utilisateur est authentifié
  getAvailableEmployees
